...
module "database" {
  ...
  private_dns_zone_id = "/subscriptions/b6f97aed-4542-491f-a94c-e0f05563485c/resourceGroups/rg-hub/providers/Microsoft.Network/privateDnsZones/privatelink.postgres.database.azure.com"
